package com.diltech.managemyfiles;
    ...
    public void onBindViewHolder(@NonNull FileViewHolder holder, int position) {
        ...
        holder.container.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                // get(position) changed to get(holder.getAdapterPosition) 1 time here
            }
        });
        ...
        holder.container.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View view) {
                listener.onFileLongClicked(file.get(holder.getAdapterPosition()), holder.getAdapterPosition());
                // get(position) changed to get(holder.getAdapterPosition) 2 time here
                return true;
            }
        });
